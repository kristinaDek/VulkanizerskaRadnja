...
public class AutoGumaTest {
	...
	@Test (expected = java.lang.RuntimeException.class)
	public void testSetMarkaModelDuzinaJe2() {
				
		assertEquals(2, a.getMarkaModel().length()); 
	}
	
	@Test (expected = java.lang.RuntimeException.class)
	public void testSetMarkaModelDuzinaJe1() {
				
		assertEquals(1, a.getMarkaModel().length()); 
	}
